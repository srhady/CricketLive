...
def create_max_logo_poster(match_name, logo1_url, logo2_url, local_path, tg_icon, font):
    """Creates a 1080x700 poster with bordered team flags and black bottom-left watermark"""
    try:
        ...
        # Giant crop ratio (480x600)
        img1 = auto_crop_and_resize(img1, 480, 600)
        img2 = auto_crop_and_resize(img2, 480, 600)
        
        # --- ADD BLACK BORDER TO TEAM FLAGS ---
        border_color = (0, 0, 0, 255) # Solid black
        border_width = 10 # 10 pixels wide beautiful border
        
        draw_border1 = ImageDraw.Draw(img1)
        draw_border2 = ImageDraw.Draw(img2)
        
        draw_border1.rectangle([(0, 0), (img1.width - 1, img1.height - 1)], outline=border_color, width=border_width)
        draw_border2.rectangle([(0, 0), (img2.width - 1, img2.height - 1)], outline=border_color, width=border_width)
        ...
        # Set explicitly for the 700 canvas height
